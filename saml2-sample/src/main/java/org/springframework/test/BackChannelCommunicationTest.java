...
public class BackChannelCommunicationTest extends ArtifactResolutionProfileBase  {

	
	private static final Logger LOGGER = LoggerFactory.getLogger(BackChannelCommunicationTest.class);
	 /**
     ...
     */
    public BackChannelCommunicationTest(HttpClient httpClient) {
    ...
    protected void getArtifactResponse(String endpointURI, SAMLMessageContext context) throws SAMLException, MessageEncodingException, MessageDecodingException, MetadataProviderException, org.opensaml.xml.security.SecurityException {
        ...
        try {
            ...
            if (responseCode != 200) {
                ...
                LOGGER.debug("Problem communicating with Artifact Resolution service, received response {}, body {}.", responseCode, responseBody);
        	...
        	LOGGER.debug("Error when sending request to artifact resolution service.", e);
